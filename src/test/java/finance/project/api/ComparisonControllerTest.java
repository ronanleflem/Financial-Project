...
public class ComparisonControllerTest {
    ...
    void testCompareSymbols() throws Exception {
        ...
        Candle candleAAPLStart = new Candle(1L, "test",symbol1,null, LocalDateTime.of(2023, 1, 1,1,1),
        ...
        Candle candleAAPLEnd = new Candle(2L,"test",symbol1,null, LocalDateTime.of(2023, 12, 31,1,1),
                BigDecimal.valueOf(110.00), BigDecimal.valueOf(110.00),
                BigDecimal.valueOf(115.00), BigDecimal.valueOf(105.00),
                BigDecimal.valueOf(1000000),BigDecimal.valueOf(0.00),BigDecimal.valueOf(0.00));

        Candle candleGOOGLStart = new Candle(3L, "test",symbol2,null, LocalDateTime.of(2023, 1, 1,1,1),
                BigDecimal.valueOf(100.00), BigDecimal.valueOf(100.00),
                BigDecimal.valueOf(105.00), BigDecimal.valueOf(95.00),
                BigDecimal.valueOf(1000000),BigDecimal.valueOf(0.00),BigDecimal.valueOf(0.00));

        Candle candleGOOGLEnd = new Candle(4L,"test",symbol2,null, LocalDateTime.of(2023, 12, 31,1,1),

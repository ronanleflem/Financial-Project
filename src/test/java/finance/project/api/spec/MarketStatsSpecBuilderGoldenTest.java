...
class MarketStatsSpecBuilderGoldenTest {
    private static final ObjectMapper MAPPER = new ObjectMapper();

    @Test
    void buildsMinimalSpec() throws Exception {
        assertGolden("market-stats-minimal-input.json", "market-stats-minimal-output.json");
    }

    @Test
    void buildsFullSpec() throws Exception {
        assertGolden("market-stats-full-input.json", "market-stats-full-output.json");
    }
    ...
    private void assertGolden(String inputFixture, String expectedFixture) throws Exception {
        ...
        PythonSpec spec = new MarketStatsSpecBuilder().build(input);
    ...
    private static String readFixture(String name) throws IOException {
        ...
        try (InputStream stream = MarketStatsSpecBuilderGoldenTest.class.getClassLoader().getResourceAsStream(path)) {
            if (stream == null) {
